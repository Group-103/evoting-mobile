        ...
        return (
            <View style={[styles.positionContainer, { backgroundColor: theme.colors.card }]}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 15 }}>
                    <Text style={[styles.positionTitle, { color: theme.colors.text, marginBottom: 0 }]}>{position.name}</Text>
                    {position.constituency && (
                        <View style={{ backgroundColor: theme.colors.primary + '20', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 4 }}>
                            <Text style={{ color: theme.colors.primary, fontSize: 12, fontWeight: 'bold' }}>{position.constituency}</Text>
                        </View>
                    )}
                </View>
