...
export default function ResultsScreen() {
    ...
    const renderChart = (position) => {
        ...
        const labels = position.candidates.map(c => c.name.split(' ')[0]);
                        ...
                        <View style={{ flex: 1, marginRight: 10 }}>
                            ...
                            {candidate.isWinner && (
                                <View style={{
                                    ...
                                    <Text style={{ color: '#10b981', fontSize: 10, fontWeight: 'bold' }}>WINNER 🏆</Text>
                                </View>
                            )}
                        </View>
                        <Text style={[styles.votes, { color: theme.colors.primary }]}>{candidate.votes}</Text>
